...
import com.example.externalvideo.R;
...
public class ManageExternalCamera implements CameraDialog.CameraDialogParent {
    ...
    SimpleUVCCameraTextureView mUVCCameraView;
    ...
    private void boradCastFrame(Bitmap bitmap){
        ByteArrayOutputStream stream = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, stream);
        byte[] byteArray = stream.toByteArray();
        Intent intent = new Intent();
        intent.setAction("r100.camera.frames");
    ...
    public ManageExternalCamera(Context context, Activity activity) {
        ...
        mUVCCameraView = (SimpleUVCCameraTextureView) activity.findViewById(R.id.UVCCamera);
        ...
        mIFrameCallback = frame -> {
            try {
                ...
                synchronized (st) {
                    ...
                    boradCastFrame(bitmap);
                   // cameraFrame.onCameraFrame(convert(bitmap, Bitmap.Config.ARGB_8888), timeStamp);
                }
            } catch (Exception e) {
    ...
    public void setUVCCameraView(SimpleUVCCameraTextureView uvcCameraView) {
